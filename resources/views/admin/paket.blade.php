        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-2">
                        <a href="{{ route('admin.tambahPaket') }}" class="btn btn-primary">+ Tambah Data</a>
                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table-group-divider">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $paket->jenis_paket }} &nbsp;Bulan</td>
                                                        <td>Rp.{{ $paket->harga }}</td>
                                                        <td>
                                                            @if ($paket && $paket->foto)
                                                            <img src="{{ asset('images/' . $paket->foto) }}" alt="Foto Paket" style="max-width: 100px; max-height: 100px;">
                                                            @endif
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" href="/admin/editPaket/{{ $paket->id }}">Edit</a>
                                                            <a class="btn btn-danger" href="/admin/hapusPaket/{{ $paket->id }}">Delete</a>
                                                        </td>
                                                    </tr>
