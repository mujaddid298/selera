                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach ($dataPemesananPaket as $pemesanan)
                                                <tr>
                                                    ...
                                                    <td>{{ $pemesanan->paket->harga }}</td>
                                                    <td>
                                                        @if ($pemesanan->bukti_pembayaran)
                                                        <img src="{{ asset('images/' . $pemesanan->bukti_pembayaran) }}" alt="Foto Bukti Pembayaran" style="max-width: 100px; max-height: 100px;">
                                                        @else
                                                        <span>No Image</span>
                                                        @endif
                                                    </td>
                                                    <td style="color: green;">{{ $pemesanan->status }}</td>
