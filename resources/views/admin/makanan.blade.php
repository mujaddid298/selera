        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-2">
                        <a href="{{ route('admin.tambahMakanan') }}" class="btn btn-primary">+ Tambah Data</a>
                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table-group-divider">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{ asset('images/' . $makanan->foto) }}" alt="Foto Makanan" style="max-width: 100px; max-height: 100px;">
                                                        </td>
                                                        <td>Rp. {{ $makanan->harga }}</td>
                                                        <td>{{ $makanan->deskripsi }}</td>
                                                        <td>
                                                            <a class="btn btn-primary" href="/admin/editMakanan/{{ $makanan->id }}">Edit</a>
                                                            <a class="btn btn-danger" href="/admin/hapusMakanan/{{ $makanan->id }}">Delete</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
