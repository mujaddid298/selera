                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tambah Makanan Baru</h6>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('postTambahMakanan') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group mt-4">
                                            <label class="text-secondary mb-2">Kode Makanan</label>
                                            <input type="text" class="form-control border border-secondary form-control" name="kode_makanan" required value="{{ old('kode_makanan') }}">
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary">Pilih Jenis Makanan</label>
                                            <select class="form-select" name="jenis_makanan">
                                                <option value=""></option>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="nama_makanan" required value="{{ old('nama_makanan') }}">
                                            <span class="text-danger">
                                                @error('nama_makanan')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="kalori" required value="{{ old('kalori') }}">
                                            <span class="text-danger">
                                                @error('kalori')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="protein" required value="{{ old('protein') }}">
                                            <span class="text-danger">
                                                @error('protein')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="lemak" required value="{{ old('lemak') }}">
                                            <span class="text-danger">
                                                @error('lemak')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="karbohidrat" required value="{{ old('karbohidrat') }}">
                                            <span class="text-danger">
                                                @error('karbohidrat')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <!-- Add other fields for protein, lemak, karbohidrat, foto, deskripsi -->
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="harga" required value="{{ old('harga') }}" placeholder="Rp.">
                                            <span class="text-danger">
                                                @error('harga')
                                                {{ $message }}
                                                @enderror
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            ...
                                            if (successMessage) {
                                                window.location.href = "{{ route('admin.makanan') }}";
                                            }
                                        });
                                    </script>
                                </div>
