        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-2">
                        <a href="{{ route('admin.tambah') }}" class="btn btn-primary">+ Tambah Data</a>
                    </div>
                                                ...
                                                <tbody class="table-group-divider">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-outline-success" href="{{ route('admin.unblockUser', ['id' => $user->id]) }}">Buka Blokir</a>

                                                            <a class="btn btn-outline-danger btn-action" href="{{ route('admin.blokirUser', ['id' => $user->id]) }}" onclick=" return confirm('Anda yakin ingin memblokir pengguna ini?')">Blokir</a>
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    @endforeach
