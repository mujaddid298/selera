                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tambah Pemesanan Baru</h6>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('postTambahPemesanan') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="kode_pemesanan" required value="{{ old('kode_pemesanan') }}">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="kodePaket" required value="{{ old('kodePaket') }}">
                                            <span class="text-danger">
                                                @error('kodePaket')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="namaMakanan" required value="{{ old('namaMakanan') }}">
                                            <span class="text-danger">
                                                @error('namaMakanan')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="total_bayar" required value="{{ old('total_bayar') }}">
                                            <span class="text-danger">
                                                @error('total_bayar')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
