                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit Data Pemesanan</h6>
                                </div>
                                <div class="card-body">
                                    <form action="/postEditPemesanan/{{ $data->kode_pemesanan }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Kode Pemesanan</label>
                                            <input type="text" class="form-control border border-secondary form-control" name="kode_pemesanan" required value="{{ $data->kode_pemesanan }}">
                                        ...
                                        <div class="form-group mt-4">
                                            <label class="text-secondary mb-2">Kode Paket</label>
                                            <input type="text" class="form-control border border-secondary form-control" name="kodePaket" required value="{{ $data->kode_paket }}">
                                            <span class="text-danger">
                                                @error('kodePaket')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary form-control" name="namaMakanan" required value="{{ $data->nama_makanan }}">
                                            <span class="text-danger">
                                                @error('namaMakanan')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Total Bayar</label>
                                            <input type="text" class="form-control border border-secondary form-control" name="total_bayar" required value="{{ $data->total_bayar }}">
                                            <span class="text-danger">
                                                @error('total_bayar')
                                                {{ $message }}
                                                @enderror
                                        ...
                                        <button type="submit" class="btn btn-primary mt-5">Update Data Paket</button>
                                    </form>
                                </div>
                            </div>
                        </div>
