...
<body>
    ...
    <div class="properties section">
        <div class="container">
            <form action="{{ route('user.detailmakanan') }}" method="GET">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Cari makanan..." name="search">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="item phone">
                                <img src="{{asset ('assets/images/phone-icon.png') }}" alt="" style="max-width: 30px;">
                                <h6>082299758781<br><span>Nomor HP</span></h6>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="item email">
                                <img src="{{asset('assets/images/email-icon.png')}}" alt="" style="max-width: 30px;">
